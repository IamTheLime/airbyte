...
import pytest
from source_gocardless.source import GocardlessStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GocardlessStream, "path", "v0/example_endpoint")
    mocker.patch.object(GocardlessStream, "primary_key", "test_primary_key")
    mocker.patch.object(GocardlessStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GocardlessStream()
